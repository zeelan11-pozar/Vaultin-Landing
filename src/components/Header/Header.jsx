        ...
        >
          <div className="mx-auto flex items-center justify-between text-secondary-900">
            <motion.div className="flex items-center gap-2 hover:text-secondary-600 transition-colors cursor-pointer">
              <motion.div transition={{ type: "spring", stiffness: 300 }}>
                <Image
                  ...
                  width={981}
                  height={141}
                  className="w-28 h-4 md:h-5 w-35 lg:w-42 lg:h-6"
                />
              </motion.div>
            </motion.div>
            ...
            {/* <div className="flex bg-[#E7EAE9] pl-6 p-1 rounded-full items-center gap-4 md:gap-6 lg:gap-6">
              <button
                className="text-secondary-900 text-sm sm:text-base lg:text-lg font-medium hover:text-primary-light transition-colors duration-300 cursor-pointer"
