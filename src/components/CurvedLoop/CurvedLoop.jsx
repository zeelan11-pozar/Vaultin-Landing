...
import {
  ...
  const CurvedLoop = ({
    ...
    return (
      <div
        className=" flex items-center justify-center w-full bg-[#f1f1f1]"
        ...
        >
          ...
          <defs>
            ...
            <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="30%" stopColor="#1974A1" />
              <stop offset="50%" stopColor="#1974A1" />
              <stop offset="70%" stopColor="#1974A1" />
